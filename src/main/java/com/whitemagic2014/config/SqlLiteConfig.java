...
public class SqlLiteConfig {
    ...
    public List<DBVersionTable> getDbVersionTables() {
        ...
        // icon
        DBVersionTable v3_0_0 = new DBVersionTable();
        v3_0_0.setVer(new Version("3.0.0"));
        List<String> sql_3_0_0 = new ArrayList<>();
        sql_3_0_0.add("DROP TABLE IF EXISTS homework_icon");
        sql_3_0_0.add("CREATE TABLE \"homework_icon\" (\n" +
                ...
                " \"serverType\" INTEGER\n" +
                ");");
        v3_0_0.setSqls(sql_3_0_0);
        result.add(v3_0_0);

        // 配置表
        DBVersionTable v3_0_1 = new DBVersionTable();
        v3_0_1.setVer(new Version("3.0.1"));
        List<String> sql_3_0_1 = new ArrayList<>();
        sql_3_0_1.add("DROP TABLE IF EXISTS settings");
        sql_3_0_1.add("CREATE TABLE \"settings\" (\n" +
                " \"id\" INTEGER PRIMARY KEY,\n" +
